...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="${pageContext.request.contextPath}/toupdateAttendanceView?id=${model.id}">新增合同信息</a>
      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${pageContext.request.contextPath}/toAddContract" title="刷新">
    ...
    <div class="layui-col-md10">
        <form class="layui-form" id="findmyinforecpt" style="height: 500px;width: 30%">
                ...
                <div class="layui-input-block">
                    <select class="form-control" name="eno" >
                        <c:forEach items="${userList}" var="user">
                            <option value="${user.eno}">${user.realname}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" lay-verify="required" name="salary"  class="layui-input" >
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="date" lay-verify="required" name="hireDate"  class="layui-input" >
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" lay-verify="required" name="note"  class="layui-input" >
                </div>
            </div>
            <div class="layui-form-item">
    ...
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data) {
            ...
            $.ajax({
                ...
                error:function(){
                    layer.msg('新增失败',{icon:0,time:3000});
                    setTimeout(function () {window.location.href='${pageContext.request.contextPath}/adminFindContract';},2000);
                }
            });
        });
